...
//       API.graphql(graphqlOperation(listRides)) as Promise<any>
//     )
//       .then((result) => {
...
//       await (
//         API.graphql(
//           graphqlOperation(deleteRide, { input: { id: oldRide.id } })
//         ) as Promise<any>
//       )
//         .then((result) => {
//           console.log(result);
...
//       await (API.graphql(graphqlOperation(listRides)) as Promise<any>)
//         .then((result) => {
