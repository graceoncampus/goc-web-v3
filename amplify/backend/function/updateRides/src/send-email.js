...
const sendDriverEmail = async (car, date, emailMessage) => {
  ...
  if (
    ...
    const message =
      ...
      "Rides Team\n" +
      "gocrides@gmail.com | (949) 295-6286 or (510) 925 3266";
